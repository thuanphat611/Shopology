    ...
    <div className="bg-black">
      <div className="pt-20 pb-[60px] w-full max-w-screen-xl px-10 lg:px-0 lg:mx-auto flex items-start justify-center sm:justify-between flex-wrap gap-x-12 gap-y-12">
        <div className="min-w-[252px] flex flex-col text-text-white">
          <h5 className="mb-6 leading-none text-[1.5rem] font-semibold">
            Shopology
          </h5>
          <h5 className="mb-6 leading-none text-[1.25rem]">Subscibe</h5>
          <p className="mb-4 leading-none text-[1rem]">
        ...
        <div className="min-w-[252px] flex flex-col text-text-white">
          <h5 className="mb-6 leading-none text-[1.25rem]">Support</h5>
          <p className="max-w-[252px] mb-4 leading-none text-[1rem]">
            111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
          </p>
          <p className="mb-4 leading-none text-[1rem]">
            shopology.support@gmail.com
          </p>
          <p className="mb-4 leading-none text-[1rem]">+88015-88888-9999</p>
        </div>

        <div className="min-w-[252px] flex flex-col text-text-white">
          <h5 className="mb-6 leading-none text-[1.25rem]">Quick link</h5>
          <Link
            to=""
        ...
        <div className="min-w-[252px] flex flex-col text-text-white">
          <h5 className="mb-6 leading-none text-[1.25rem]">Download App</h5>
          <p className="opacity-70 font-medium text-[0.75rem] leading-none mb-2">
            Save $3 with App New User Only
          </p>
          <div className="flex mb-6 gap-x-2">
            <QRCodeSVG
              value="https://github.com/thuanphat611"
              marginSize={1}
              size={80}
            />
